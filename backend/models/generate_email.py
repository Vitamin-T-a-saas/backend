...
def run_email_agent(state=None, action="generate_idea"):
    """Main function to run the email agent - API-compatible signature"""
    try:
    ...
    # You should implement logic to use state/action if needed
    return {"success": True, "message": "Email agent executed", "action": action, "state": state}
